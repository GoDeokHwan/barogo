...
public class DeliveryServiceTest {
    ...
    void 배달_주소_변경_실패() {
        // 대기중이 아닐때 실패
        assertThrows(RuntimeException.class, () -> {
            deliveryService.modifyAddress(1L, DeliveryAddressModifyRequest.of("경기도 수원시"));
        });
        // 없은 배달
        assertThrows(RuntimeException.class, () -> {
            deliveryService.modifyAddress(6L, DeliveryAddressModifyRequest.of("경기도 수원시"));
        });
    }
    ...
    void 배달_주소_변경() {
        DeliveryDTO delivery = deliveryService.modifyAddress(3L, DeliveryAddressModifyRequest.of("경기도 수원시"));
